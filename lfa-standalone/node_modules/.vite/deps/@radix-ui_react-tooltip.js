...
import {
  ...
  useLayoutEffect2
} from "./chunk-VPQFPPET.js";
import {
  require_react_dom
} from "./chunk-3NEDSATR.js";
import {
  require_jsx_runtime
} from "./chunk-6JQHTP3U.js";
import {
  require_react
} from "./chunk-QI6TWUTQ.js";
import {
  __toESM
...
var Arrow = React3.forwardRef(
  __name2(function Arrow2(props, forwardedRef) {
...
var PopperAnchor = React5.forwardRef(
  __name4(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = React5.forwardRef(
  __name4(function PopperContent2(props, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name4((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name4(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React5.forwardRef(
  __name4(function PopperArrow2(props, forwardedRef) {
...
__name4(isNotNull, "isNotNull");
var transformOrigin = __name4((options) => ({
...
__name4(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root22 = Popper;
...
var TooltipProvider = __name5((props) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name5((props) => {
  ...
  const [contentIdState, setContentId] = React6.useState(void 0);
...
var TooltipTrigger = React6.forwardRef(
  __name5(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name5((props) => {
...
var TooltipContent = React6.forwardRef(
  __name5(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React6.forwardRef(__name5(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  ...
  React6.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name5((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name5((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React6.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name5((event) => {
...
var TooltipContentImpl = React6.forwardRef(
  ...
  __name5(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React6.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name5((event) => {
        ...
        children: (0, import_jsx_runtime3.jsxs)(
          Content,
          {
            ...
            children: [
              ...
              ariaLabel ? (0, import_jsx_runtime3.jsx)(Root, { id: context.contentId, role: "tooltip", children: ariaLabel }) : null
            ]
          }
        )
      }
...
var TooltipArrow = React6.forwardRef(
  __name5(function TooltipArrow2(props, forwardedRef) {
...
__name5(getExitSideFromRect, "getExitSideFromRect");
...
__name5(getPaddedExitPoints, "getPaddedExitPoints");
...
__name5(getPointsFromRect, "getPointsFromRect");
...
__name5(isPointInPolygon, "isPointInPolygon");
...
__name5(getHullPresorted, "getHullPresorted");
