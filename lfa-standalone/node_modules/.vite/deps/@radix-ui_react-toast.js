...
function createCollection(name) {
  ...
  const CollectionProvider = __name((props) => {
...
}, _keys = new WeakMap(), __name(_a, "OrderedDict"), _a);
...
var ToastProvider = __name2((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React3.forwardRef(
  __name2(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React3.useEffect(() => {
      const handleKeyDown = __name2((event) => {
        var _a2;
    ...
    React3.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name2((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name2(() => {
...
var FocusProxy = React3.forwardRef(
  ...
  __name2(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React3.forwardRef(
  // blank line to reduce diff noise
  __name2(function Toast2(props, forwardedRef) {
...
var ToastImpl = React3.forwardRef(
  __name2(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
...
var ToastAnnounce = __name2((props) => {
...
var ToastTitle = React3.forwardRef(
  __name2(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React3.forwardRef(
  // blank line to reduce diff noise
  __name2(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React3.forwardRef(
  __name2(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React3.forwardRef(
  __name2(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React3.forwardRef(__name2(function ToastAnnounceExclude2(props, forwardedRef) {
...
var isDeltaInDirection = __name2((delta, direction, threshold = 0) => {
